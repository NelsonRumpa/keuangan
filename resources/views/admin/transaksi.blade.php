...
<body>
    ...
    <button type="button" class="btn btn-primary" onclick="window.location='{{ route('cetakpdf') }}'" href>
      <i class="fa fa-file-pdf-o" aria-hidden="true"></i> </button>

    <button type="button" class="btn btn-primary" onclick="window.location='{{ route('excel') }}'" href><i class="fa fa-file-excel-o" aria-hidden="true"></i></button>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ route('postra2') }}" method="post" enctype="multipart/form-data">
              @csrf
...
@foreach($sortedDates as $tanggal)
    <table class="table" action="{{ route('gettran2') }}" method="get">
